...
" Perforce shortcuts
"map   <T-E>    :silent !p4 edit %<CR>
" Win-E
map   å        :silent !p4 edit %<CR>
" Win-R
map   ò        :silent !p4 revert %<CR>
" Win-S
map   ó        :call P4Submit()<CR>

function P4Submit()
  let n = inputdialog("Enter changelist description: ")
  if n != ""
"   echo "!p4 submit -d " . n . " %"
    execute "!p4 submit -d " . n . " %"
  endif
endfunction
...
Bundle 'mako.vim'
" blinks/vim-antlr.git
Bundle 'vim-antlr.git'
...
Bundle 'vim-do-syntax'
Bundle 'vim-mft-syntax'
Bundle 'vim-ralf-syntax'
